...
namespace EmployeePayRollADO
{
    ...
    {
        public static string connectionstring = @"Server=(localdb)\MSSQLLocalDB;Database=Demo194;Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true;Integrated Security=True";
